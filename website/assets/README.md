...
ضع صوراً حقيقية من الأنظمة في هذا المجلد. إن لم تُضف ملفاً، تظهر **معاينة CSS** تلقائياً.
...
| الملف | الاستخدام |
|-------|-----------|
| `mobile-app.png` | تبويب الجوال + قسم التطبيق |
| `mobile-hotel.png` | (اختياري) profile فندق |
| `mobile-car.png` | (اختياري) profile سيارات |

**التوصيات:** PNG أو WebP — ~1200px للسطح المكتب، ~600px للجوال.
