...
const FALLBACK_DOWNLOAD = 'https://github.com/mohsenkadm/AlMuhasib/releases/download/v1.14.30/Qayd-Setup-1.14.30.exe';
...
async function loadVersion() {
  ...
  try {
    ...
    if (els.version) els.version.textContent = '1.14.30';
