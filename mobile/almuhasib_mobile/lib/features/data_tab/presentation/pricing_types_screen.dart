...
class PricingTypesScreen extends GetView<PricingTypesController> {
  ...
  Widget build(BuildContext context) {
    return AppListPage<PricingTypeLookupItem>(
      ...
      itemBuilder: (context, item, index) => AppEntityCard(
        ...
        leading: Container(
          ...
          decoration: BoxDecoration(
            color: AppColors.modulePink.withValues(alpha: 0.14),
            borderRadius: BorderRadius.circular(14),
          ),
          child: const Icon(Icons.sell_outlined, color: AppColors.modulePink),
        ),
