...
class RealEstateContractsController extends GetxController {
  final search = ''.obs;
  ...
  final items = <RealEstateContractListItem>[].obs;
  ...
  Future<void> load() async {
    ...
    error.value = null;
    try {
      items.value = await AppServices.realEstate.getContracts(
