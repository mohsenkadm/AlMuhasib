...
namespace AlMuhasib.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260816170000_AddProductOffers")]
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductOffers_Products_GiftProductId",
                        column: x => x.GiftProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductOffers_Products_TriggerProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductOffers_IsDeleted",
                table: "ProductOffers",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_ProductOffers_SyncId",
                table: "ProductOffers",
                column: "SyncId");
