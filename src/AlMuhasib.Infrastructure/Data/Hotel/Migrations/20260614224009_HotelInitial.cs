        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CancellationPolicy = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_HotelExpenses_HotelExpenseTypes_HotelExpenseTypeId",
                        column: x => x.HotelExpenseTypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RatePlanSeasons", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RatePlanSeasons_RatePlans_RatePlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_HotelVouchers_Reservations_ReservationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReservationPayments_HotelCashBoxes_HotelCashBoxId",
                        column: x => x.HotelCashBoxId,
                        principalTable: "HotelCashBoxes",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Floors_IsDeleted",
                table: "Floors",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_Floors_SyncId",
                table: "Floors",
                column: "SyncId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Guests_SyncId",
                table: "Guests",
                column: "SyncId");

            migrationBuilder.CreateIndex(
                name: "IX_HotelCashBoxes_IsDeleted",
                table: "HotelCashBoxes",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_HotelCashBoxes_SyncId",
                table: "HotelCashBoxes",
                column: "SyncId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HotelExpenses_HotelExpenseTypeId",
                table: "HotelExpenses",
                column: "HotelExpenseTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_HotelExpenses_IsDeleted",
                table: "HotelExpenses",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_HotelExpenses_SyncId",
                table: "HotelExpenses",
                column: "SyncId");

            migrationBuilder.CreateIndex(
                name: "IX_HotelExpenseTypes_IsDeleted",
                table: "HotelExpenseTypes",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_HotelExpenseTypes_SyncId",
                table: "HotelExpenseTypes",
                column: "SyncId");

            migrationBuilder.CreateIndex(
                name: "IX_HotelSettings_IsDeleted",
                table: "HotelSettings",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_HotelSettings_SyncId",
                table: "HotelSettings",
                column: "SyncId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HotelVouchers_IsDeleted",
                table: "HotelVouchers",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HotelVouchers_SyncId",
                table: "HotelVouchers",
                column: "SyncId");

            migrationBuilder.CreateIndex(
                name: "IX_HotelVouchers_VoucherNumber",
                table: "HotelVouchers",
                column: "VoucherNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_HousekeepingTasks_IsDeleted",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HousekeepingTasks_SyncId",
                table: "HousekeepingTasks",
                column: "SyncId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RatePlans_SyncId",
                table: "RatePlans",
                column: "SyncId");

            migrationBuilder.CreateIndex(
                name: "IX_RatePlanSeasons_IsDeleted",
                table: "RatePlanSeasons",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_RatePlanSeasons_RatePlanId",
                table: "RatePlanSeasons",
                column: "RatePlanId");

            migrationBuilder.CreateIndex(
                name: "IX_RatePlanSeasons_SyncId",
                table: "RatePlanSeasons",
                column: "SyncId");

            migrationBuilder.CreateIndex(
                name: "IX_ReservationCharges_IsDeleted",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationCharges_SyncId",
                table: "ReservationCharges",
                column: "SyncId");

            migrationBuilder.CreateIndex(
                name: "IX_ReservationPayments_HotelCashBoxId",
                table: "ReservationPayments",
                column: "HotelCashBoxId");

            migrationBuilder.CreateIndex(
                name: "IX_ReservationPayments_IsDeleted",
                table: "ReservationPayments",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationPayments_SyncId",
                table: "ReservationPayments",
                column: "SyncId");
