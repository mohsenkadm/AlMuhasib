...
namespace AlMuhasib.Infrastructure.Data.RealEstate.Migrations
{
    ...
    [Migration("20260727125221_RealEstateExpensesAndTypes")]
    partial class RealEstateExpensesAndTypes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlMuhasib.Core.Entities.RealEstate.RealEstateClauseTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RealEstateClauseTemplates", (string)null);
                });

            modelBuilder.Entity("AlMuhasib.Core.Entities.RealEstate.RealEstateContract", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RealEstateContracts", (string)null);
                });

            modelBuilder.Entity("AlMuhasib.Core.Entities.RealEstate.RealEstateContractClause", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RealEstateContractClauses", (string)null);
                });

            modelBuilder.Entity("AlMuhasib.Core.Entities.RealEstate.RealEstateContractPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RealEstateContractPayments", (string)null);
                });

            modelBuilder.Entity("AlMuhasib.Core.Entities.RealEstate.RealEstateExpense", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RealEstateExpenses", (string)null);
                });

            modelBuilder.Entity("AlMuhasib.Core.Entities.RealEstate.RealEstateExpenseType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RealEstateExpenseTypes", (string)null);
                });

            modelBuilder.Entity("AlMuhasib.Core.Entities.RealEstate.RealEstateParty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RealEstateParties", (string)null);
                });
            ...
            modelBuilder.Entity("AlMuhasib.Core.Entities.RealEstate.RealEstateContractClause", b =>
                {
                    b.HasOne("AlMuhasib.Core.Entities.RealEstate.RealEstateContract", "Contract")
                        .WithMany("Clauses")
            ...
            modelBuilder.Entity("AlMuhasib.Core.Entities.RealEstate.RealEstateExpense", b =>
                {
                    b.HasOne("AlMuhasib.Core.Entities.RealEstate.RealEstateExpenseType", "ExpenseType")
                        .WithMany("Expenses")
                        .HasForeignKey("ExpenseTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AlMuhasib.Core.Entities.RealEstate.RealEstateContract", "RelatedContract")
                        .WithMany()
