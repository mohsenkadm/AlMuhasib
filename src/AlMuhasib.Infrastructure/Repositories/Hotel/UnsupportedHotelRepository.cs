...
internal sealed class UnsupportedHotelRepository<T> : IRepository<T> where T : BaseEntity
{
    private static NotSupportedException Error =>
        new("This data module is not available in the hotel management system.");
