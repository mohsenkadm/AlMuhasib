...
namespace AlMuhasib.Infrastructure.Repositories.Hotel;

public class HotelRepository<T> : IRepository<T> where T : BaseEntity
{
    private readonly IDbContextFactory<HotelDbContext> _contextFactory;
    private readonly Func<HotelDbContext?> _getActiveContext;

    public HotelRepository(IDbContextFactory<HotelDbContext> contextFactory, Func<HotelDbContext?> getActiveContext)
    {
