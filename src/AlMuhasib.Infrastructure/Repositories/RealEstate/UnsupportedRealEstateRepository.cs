...
internal sealed class UnsupportedRealEstateRepository<T> : IRepository<T> where T : BaseEntity
{
    private static NotSupportedException Error =>
        new("This data module is not available in the real estate contracts system.");
