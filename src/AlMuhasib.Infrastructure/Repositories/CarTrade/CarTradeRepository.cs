...
namespace AlMuhasib.Infrastructure.Repositories.CarTrade;

public class CarTradeRepository<T> : IRepository<T> where T : BaseEntity
{
    private readonly IDbContextFactory<CarTradeDbContext> _contextFactory;
    private readonly Func<CarTradeDbContext?> _getActiveContext;

    public CarTradeRepository(IDbContextFactory<CarTradeDbContext> contextFactory, Func<CarTradeDbContext?> getActiveContext)
    {
