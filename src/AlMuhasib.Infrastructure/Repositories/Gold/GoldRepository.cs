...
public class GoldRepository<T> : IRepository<T> where T : BaseEntity
{
    private readonly IDbContextFactory<GoldDbContext> _contextFactory;
    private readonly Func<GoldDbContext?> _getActiveContext;

    public GoldRepository(IDbContextFactory<GoldDbContext> contextFactory, Func<GoldDbContext?> getActiveContext)
    {
