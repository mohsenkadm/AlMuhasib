...
public static class ScreenPermissionRegistry
{
    ...
    [
        ...
        ("PackagingTypes", "أنواع التعبئة"),
        ("PricingTypes", "أنواع التسعير"),
        ("ProductPricing", "تسعير منتجات"),
        (BarcodePriceCheck, "فحص السعر بالباركود"),
        ("Customers", "العملاء"),
        ("Drivers", "السواقين"),
        ("SalesRepresentatives", "المندوبين"),
        ("SalesRepCommissionRules", "قواعد عمولة المندوبين"),
        ("SalesRepTargets", "أهداف المندوبين"),
        ("SalesRepCollections", "تحصيلات المندوبين"),
        ("SalesRepStatement", "كشف حساب المندوب"),
        ("SalesRepPerformance", "أداء المندوبين"),
        ("SalesRepCustomers", "عملاء المندوب"),
        ("Suppliers", "الموردون"),
        ("PersonProfile", "ملف الشخص"),
        ("UserActivityProfile", "ملف المستخدم"),
        ("LoyaltySettings", "إعدادات الولاء"),
        ("LoyaltyAccounts", "حسابات ولاء الزبائن"),
        ("LoyaltyLedger", "سجل حركات النقاط"),
        ...
        ("OpeningCustomerBalances", "أرصدة العملاء الافتتاحية"),
        ("OpeningSupplierBalances", "أرصدة الموردين الافتتاحية"),
        ("Vouchers", "السندات"),
        ("Expenses", "المصاريف"),
        ...
        ("CustomFieldSettings", "إعدادات الحقول"),
    ...
    private static readonly Dictionary<Type, string> ViewModelToScreen = new()
    {
        ...
        [typeof(DriversViewModel)] = "Drivers",
        [typeof(SalesRepresentativesViewModel)] = "SalesRepresentatives",
        [typeof(SalesRepCommissionRulesViewModel)] = "SalesRepCommissionRules",
        [typeof(SalesRepTargetsViewModel)] = "SalesRepTargets",
        [typeof(SalesRepCollectionsViewModel)] = "SalesRepCollections",
        [typeof(SalesRepStatementViewModel)] = "SalesRepStatement",
        [typeof(SalesRepPerformanceReportViewModel)] = "SalesRepPerformance",
        [typeof(SalesRepCustomersReportViewModel)] = "SalesRepCustomers",
        [typeof(SuppliersViewModel)] = "Suppliers",
        [typeof(PersonProfileViewModel)] = "PersonProfile",
        [typeof(UserActivityProfileViewModel)] = "UserActivityProfile",
        [typeof(LoyaltySettingsViewModel)] = "LoyaltySettings",
        [typeof(LoyaltyAccountsViewModel)] = "LoyaltyAccounts",
        [typeof(LoyaltyLedgerViewModel)] = "LoyaltyLedger",
        [typeof(LoyaltySummaryReportViewModel)] = "LoyaltyReports",
        [typeof(LoyaltyTopCustomersReportViewModel)] = "LoyaltyReports",
        [typeof(ProductOffersViewModel)] = "ProductOffers",
        ...
        [typeof(OpeningCustomerBalanceViewModel)] = "OpeningCustomerBalances",
        [typeof(OpeningSupplierBalanceViewModel)] = "OpeningSupplierBalances",
        ...
        [typeof(MaterialNetProfitReportViewModel)] = "Reports",
        [typeof(LeastProfitMaterialsReportViewModel)] = "Reports",
        [typeof(CustomerNetProfitReportViewModel)] = "Reports",
        [typeof(LeastProfitCustomersReportViewModel)] = "Reports",
        ...
        [typeof(ExpiryReportViewModel)] = "Reports",
        ...
        [typeof(InvestorProfitDistributionsReportViewModel)] = SupervisoryReports,
        [typeof(CapitalMovementReportViewModel)] = SupervisoryReports,
        [typeof(OpeningInstallmentBalancesReportViewModel)] = "Reports",
        [typeof(CompanyFeeReportViewModel)] = "Reports",
        ...
        [typeof(ReceivablesAgingReportViewModel)] = "Reports",
        [typeof(PayablesAgingReportViewModel)] = "Reports",
        [typeof(CustomerCollectionsReportViewModel)] = "Reports",
        [typeof(OverdueCustomersReportViewModel)] = "Reports",
        [typeof(SupplierPaymentsReportViewModel)] = "Reports",
        [typeof(BankAccountStatementReportViewModel)] = "Reports",
        [typeof(CashBoxMovementReportViewModel)] = "Reports",
        [typeof(CashBalancesSummaryReportViewModel)] = "Reports",
        [typeof(TransfersReportViewModel)] = "Reports",
        [typeof(InventoryValuationReportViewModel)] = "Reports",
        [typeof(WarehouseProductProfitReportViewModel)] = "Reports",
        ...
        [typeof(ExchangeRatesViewModel)] = "ExchangeRates",
        [typeof(CustomFieldSettingsViewModel)] = "CustomFieldSettings",
    ...
    private static readonly Dictionary<string, Type> ScreenToDefaultViewModel = new()
    {
        ...
        ["PackagingTypes"] = typeof(PackagingTypesViewModel),
        ...
        ["Drivers"] = typeof(DriversViewModel),
        ["SalesRepresentatives"] = typeof(SalesRepresentativesViewModel),
        ["SalesRepCommissionRules"] = typeof(SalesRepCommissionRulesViewModel),
        ["SalesRepTargets"] = typeof(SalesRepTargetsViewModel),
        ["SalesRepCollections"] = typeof(SalesRepCollectionsViewModel),
        ["SalesRepStatement"] = typeof(SalesRepStatementViewModel),
        ["SalesRepPerformance"] = typeof(SalesRepPerformanceReportViewModel),
        ["SalesRepCustomers"] = typeof(SalesRepCustomersReportViewModel),
        ["Suppliers"] = typeof(SuppliersViewModel),
        ["PersonProfile"] = typeof(PersonProfileViewModel),
        ["UserActivityProfile"] = typeof(UserActivityProfileViewModel),
        ["LoyaltySettings"] = typeof(LoyaltySettingsViewModel),
        ["LoyaltyAccounts"] = typeof(LoyaltyAccountsViewModel),
        ["LoyaltyLedger"] = typeof(LoyaltyLedgerViewModel),
        ...
        ["OpeningCustomerBalances"] = typeof(OpeningCustomerBalanceViewModel),
        ["OpeningSupplierBalances"] = typeof(OpeningSupplierBalanceViewModel),
        ...
        ["ExchangeRates"] = typeof(ExchangeRatesViewModel),
        ["CustomFieldSettings"] = typeof(CustomFieldSettingsViewModel),
