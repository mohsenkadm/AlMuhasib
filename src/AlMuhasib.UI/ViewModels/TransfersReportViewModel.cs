...
public partial class TransfersReportViewModel : ReportViewModelBase
{
    ...
    private List<TransferReportRow> _allRows = [];
    public ObservableCollection<TransferReportRow> Rows { get; } = [];

    public TransfersReportViewModel(IReportService reportService, IUnitOfWork unitOfWork,
        IExportService exportService, ICurrentUserService currentUserService)
        : base(reportService, unitOfWork, exportService, currentUserService)
    {
        PageTitle = "تقرير التحويلات";
