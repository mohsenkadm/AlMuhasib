...
public partial class App : Application
{
    ...
    private void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddTransient<BulkProductsEntryViewModel>();
        ...
        services.AddTransient<SalesRepCollectionsViewModel>();
        services.AddTransient<SalesRepStatementViewModel>();
        services.AddTransient<SalesRepPerformanceReportViewModel>();
        services.AddTransient<SalesRepCustomersReportViewModel>();
        ...
        services.AddTransient<ExecutiveSummaryReportViewModel>();
        ...
        services.AddTransient<GoldSupplierStatementViewModel>();
        services.AddTransient<GoldSupplierPaymentViewModel>();
        ...
        services.AddTransient<GoldCategoriesViewModel>();
